[myprojecttml-eb48] Operating Details
====================================

Generated On: 2024-10-17 16:52:32 UTC
...
.. important::
   ...
   **not be valid if your [myprojecttml-eb48] container is NOT running**.

.. tip::
   You must have your [myprojecttml-eb48] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   shubjoshi/myprojecttml-eb48-amd64 (https://hub.docker.com/r/shubjoshi/myprojecttml-eb48-amd64)
...
.. important::
   docker run -d -p 49549:49549 -p 41243:41243 -p 56983:56983 \-\-env TSS=0 \-\-env SOLUTIONNAME=myprojecttml-eb48 \-\-env SOLUTIONDAG=solution_preprocessing_dag-myprojecttml-eb48 \-\-env GITUSERNAME=joshi-shubham  \-\-env GITREPOURL=https://github.com/joshi-shubham/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=49549  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=41243  \-\-env SOLUTIONVIPERVIZPORT=56983 \-\-env DOCKERUSERNAME='shubjoshi'  \-\-env EXTERNALPORT=34541 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='shubjoshi2056@gmail.com' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  shubjoshi/myprojecttml-eb48-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=56983
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=49549
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - shubjoshi/myprojecttml-eb48-amd64
...
It can be accessed by entering: http://localhost:41243
...
.. important::
   http://localhost:56983/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:56983/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:56983/<html file>
...
[myprojecttml-eb48] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/joshi-shubham/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/myprojecttml-eb48
...
.. important::
   https://myprojecttml-eb48.readthedocs.io
...
.. important::
   solution_preprocessing_dag-myprojecttml-eb48
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=49549, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=38261, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=38891, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=37771, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=39709, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=40857, HPDEHOST=127.0.1.1, HPDEPORT=41971, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=43459
